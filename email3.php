...
$mensagem = "<p style='text-align: justify;'><strong>Enviaram a seguinte mensagem:</strong></p>";
...
$mensagem .= "<p style='text-align: justify;'><strong>Mensagem:</strong> $mensagem2</p>";

// Enviar e-mail com a mensagem gerada
enviarEmail("Mensagem recebida!", $mensagem, $email_host, $email_user, $email_pass, $email_port, $email_destinatario, $email_destinatario2, $caminho_imagem);
?>
