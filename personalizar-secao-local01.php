      ...
      <form action="altera-secao-local-local01.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Insira as informações do local01:</h3>
            <!-- tools box -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <h4>Imagem:</h4>
                      <input value="<?= isset($infos['local_local01_imagem']) ? $infos['local_local01_imagem'] : ''; ?>" type="hidden" name="local_local01_imagem_anterior">
                      
                      <?php if (!empty($infos['local_local01_imagem'])): ?>
                      <img id="blah" src="upload/<?= ($infos['local_local01_imagem']) ?>" class="thumbnail img-rounded img-md"/>
                      <input id="imgLocalInput" value="<?= ($infos['local_local01_imagem']) ?>" type="file" name="local_local01_imagem" class="form-control-file" accept=".jpg, .jpeg, .heic, .webp">
                      <br>
                      <a data-url="apaga-foto-local1?id=" data-id="<?= $infos['local_local01_imagem'] ?>" class="btn btn-danger" data-toggle="modal" data-target="#modal-excluir">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <h4>Titulo:</h4>
                      <textarea name="local_local01_titulo" class="form-control"><?= htmlspecialchars($infos['local_local01_titulo']) ?></textarea>
                    </div>
                </div>

                <?php
// Verifica se data_festa é igual a data_casamento
$checked = ($infos['data_local01'] === $infos['data_casamento']) ? 'checked' : '';
?>
    ...
    if (checkbox.checked) {
      ...
      campoDataFesta.style.display = 'block';
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <h4>Horário:</h4>
                      <textarea name="local_local01_horario" class="form-control"><?= htmlspecialchars($infos['local_local01_horario']) ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="local_local01_mapa" class="form-control"><?= htmlspecialchars($infos['local_local01_mapa']) ?></textarea>
                  </div>
                </div>
