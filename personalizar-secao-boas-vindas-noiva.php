  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Dados da Noiva</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">

      <form action="altera-secao-boas-vindas-noiva.php" method="POST" enctype="multipart/form-data">

        <!-- Cabecalho -->
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Insira as informações da noiva:</h3>
            <!-- tools box -->
...
<div class="col-md-6">
    <div class="form-group">
        <h4>Imagem:</h4>
        <input value="<?= isset($infos['noiva_img']) ? $infos['noiva_img'] : ''; ?>" type="hidden" name="noiva_img_anterior">
        
        <?php if (!empty($infos['noiva_img'])): ?>
            <!-- Imagem existente -->
            <img id="blah" src="upload/<?= $infos['noiva_img']; ?>" class="thumbnail img-rounded img-md" />
            
            <!-- Input para novo arquivo -->
            <input id="imgLocalInput" type="file" name="noiva_img" class="form-control-file" accept=".jpg, .jpeg, .heic, .webp">
            <br>
            <a data-url="apaga-foto-noiva?id=" data-id="<?= $infos['noiva_img']; ?>" class="btn btn-danger" data-toggle="modal" data-target="#modal-excluir">
        ...
        <?php endif; ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <h4>Nome:</h4>
                      <input value="<?= ($infos['noiva_nome']) ?>" type="text" name="noiva_nome" class="form-control">
                    </div>
                </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <h4>Texto:</h4>                    
            <textarea name="noiva_desc" id="noiva_desc" class="form-control"><?= ($infos['noiva_desc']) ?></textarea>
        </div>
    </div>
</div>
                </div>
...
var submenu = document.querySelectorAll('#liPersoSecaoBoasVindasNoiva');
var item = submenu[0];
item.classList.add("active");
</script>
