          ...
          <div class="box-body pad" style="">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <h4>Título:</h4>
                <textarea name="presenca_titulo" class="form-control"><?= htmlspecialchars($infos['presenca_titulo']) ?></textarea>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <h4>Subtítulo:</h4>
                <textarea name="presenca_subtitulo" class="form-control"><?= htmlspecialchars($infos['presenca_subtitulo']) ?></textarea>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <h4>Aviso:</h4>
                <textarea name="presenca_aviso" class="form-control"><?= htmlspecialchars($infos['presenca_aviso']) ?></textarea>
              </div>
            </div>
