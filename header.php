...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="personalizar-banner-principal" class="logo">
...
<?php if ($_SESSION["usuario_permissao"] == "admin"){?> 
        <li id="liPerso" class=" treeview">
          ...
          <ul class="treeview-menu" style="">
            ...
            <li id="liPersoVideo"><a href="personalizar-video"><i class="fa fa-circle-o"></i> Vídeo principal</a></li>
            <li id="liPersoVideo2"><a href="personalizar-video2"><i class="fa fa-circle-o"></i> Vídeo de agradecimento</a></li>
            <li id="liPersoTextoPre"><a href="personalizar-texto-presente"><i class="fa fa-circle-o"></i> Texto de agradecimento</a></li>
          </ul>
        </li>
        ...
        <li id="liPresentes" class="treeview">
          ...
          <ul class="treeview-menu" style="">
            ...
            <li id="liCadRec"><a href="recebidos"><i class="fa fa-circle-o"></i> Presentes recebidos</a></li>
          </ul>
        </li><li id="liTransfer"><a href="transferencias">
          <i class="fa fa-money"></i> <span>Transferências recebidas</span>
          <span class="pull-right-container">
          </span>
        </a></li>
