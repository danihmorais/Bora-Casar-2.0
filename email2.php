...
$mensagem = "<p style='text-align: justify;'><strong>Parabéns! Informaram a seguinte doação em dinheiro:</strong></p>";
...
enviarEmail("Dinheiro recebido!", $mensagem, $email_host, $email_user, $email_pass, $email_port, $email_destinatario, $email_destinatario2, $caminho_imagem);
?>
