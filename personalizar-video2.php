...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small>edite o vídeo de agradecimento dos presentes do seu site</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <form id="videoForm" enctype="multipart/form-data">
      ...
      <div id="fotos" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Insira o vídeo dos presentes:</h3>
          <!-- tools box -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <h4>Inserir vídeo:</h4>
                <small>Caso não inserir nenhum vídeo, será usado o texto informado no submenu "Texto de agradecimento"</small>
                <p></p>
                <video id="videoPreview" controls width="320" height="240" class="thumbnail img-rounded img-md">
                  <?php if (!empty($infos['video_presente'])): ?>
                ...
                <input type="hidden" name="video_anterior" value="<?= $infos['video_presente'] ?>">
              </div>
              <button type="submit" class="btn btn-success">Enviar vídeo</button>
              <a data-url="apaga-video2?id=" data-id="<?= $infos['video_presente'] ?>" class="btn btn-danger" data-toggle="modal" data-target="#modal-excluir"><i class="fa fa-trash-o"></i></a>
            </div>
          </div>
        </div>
      </div>
...
document.getElementById('videoForm').onsubmit = function(event) {
    ...
    xhr.open('POST', 'adiciona-video2.php', true);
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            setTimeout(function() {
                window.location.href = "personalizar-video2"; // Redireciona ao concluir
...
var submenu = document.querySelectorAll('#liPersoVideo2');
var item = submenu[0];
item.classList.add("active");
</script>
