 ...
 <!-- Content Wrapper. Contains page content -->
                    ...
                    <div class="col-xs-12">
                          <table id="tabela" class="table table-bordered table-striped">
                            ...
                            ?>
                                  ...
                                  <td><?= $transferencia['telefone'] ?></td>
                                  <td><?= implode('-', array_reverse(explode('-', $transferencia['data']))) ?></td>
                                  <td>
  <?php
  ...
  ?>
                                  ...
                                  <td class="text-center">
                                    ...
                                    <a data-url="exclui-transferencia?id=" data-id="<?= $transferencia['id'] ?>" class="btn btn-danger" data-toggle="modal" data-target="#modal-excluir"><i class="fa fa-trash-o"></i></a>
